        ...
        <div className="max-w-7xl mx-auto px-4 w-full">
          <div className="max-w-3xl">
            <div className={`transform transition-all duration-1000 ${
              ...
              <div className="bg-gradient-to-r from-cyan-500/90 to-blue-600/90 backdrop-blur-sm p-8 md:p-12 rounded-3xl transform hover:scale-105 transition-all duration-500 shadow-2xl border border-white/20">
                <div className="space-y-6">
                  <h1 className="text-4xl md:text-7xl font-bold text-white leading-tight animate-slideInLeft">
                  ...
                  <div className="w-24 h-1 bg-white animate-expandWidth"></div>
                  
                  <p className="text-white/90 text-lg md:text-xl leading-relaxed animate-fadeInUp">
                    {slides[currentSlide].subtitle}
                  </p>
                  
                  <div className="flex flex-col sm:flex-row gap-4 pt-4">
                    <button className="group bg-white text-blue-900 px-8 py-4 rounded-full font-semibold hover:bg-blue-50 transition-all duration-300 hover:scale-105 shadow-lg transform hover:-translate-y-1 relative overflow-hidden">
                    ...
                    <button className="group flex items-center space-x-3 bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-blue-900 transition-all duration-300 hover:scale-105 shadow-lg transform hover:-translate-y-1">
