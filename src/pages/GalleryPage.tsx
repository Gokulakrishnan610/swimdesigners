    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="relative h-[340px] md:h-[400px] flex items-center justify-center overflow-hidden" data-aos="fade-down" data-aos-duration="1200">
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-white drop-shadow-lg mb-2">Gallery</h1>
          <p className="text-lg md:text-xl text-blue-100 font-medium">Our Work & Projects</p>
        </div>
        {/* Decorative wave */}
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="columns-1 sm:columns-2 md:columns-3 lg:columns-4 gap-4 [column-fill:_balance]">
          {imageEntries.map(([path, mod], i) => (
            <div
              key={path}
              className="mb-4 break-inside-avoid relative group overflow-hidden rounded-2xl shadow-lg cursor-pointer"
              data-aos="zoom-in-up"
              data-aos-delay={i * 60}
            ...
            >
              ...
              />
              {/* Overlay on hover */}
              <div className="absolute inset-0 bg-gradient-to-t from-blue-900/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-4">
                <span className="text-white text-lg font-semibold drop-shadow-lg">Photo {i + 1}</span>
              </div>
            </div>
          ))}
        </div>
