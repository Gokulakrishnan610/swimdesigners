    ...
    <div className="bg-gray-50">
      ...
      <section className="relative h-[280px] sm:h-[340px] md:h-[400px] flex items-center justify-center overflow-hidden" data-aos="fade-down" data-aos-duration="1200">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white drop-shadow-lg mb-2">About us</h1>
          <p className="text-base sm:text-lg md:text-xl text-blue-100 font-medium">Get to know Veni Enterprises</p>
        </div>
        {/* Decorative wave */}
      ...
      {/* Main Content */}
      <section className="max-w-6xl mx-auto px-2 sm:px-4 py-8 sm:py-12 grid md:grid-cols-2 gap-8 sm:gap-10 items-center">
        {/* Info Block */}
        <div data-aos="fade-right" data-aos-duration="1200">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-900 mb-3 sm:mb-4">Who We Are</h2>
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
            <div className="bg-blue-800 text-white rounded-xl sm:rounded-2xl px-4 sm:px-6 py-3 sm:py-4 shadow-lg flex flex-col items-center w-full sm:w-auto" data-aos="zoom-in" data-aos-delay="200">
              <span className="text-2xl sm:text-3xl md:text-4xl font-extrabold">25+</span>
              <span className="text-xs uppercase tracking-wider mt-1">Years Experience</span>
            </div>
            <div className="bg-white rounded-xl sm:rounded-2xl px-4 sm:px-6 py-3 sm:py-4 shadow-lg flex flex-col items-center border border-blue-100 w-full sm:w-auto" data-aos="zoom-in" data-aos-delay="400">
              <span className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-blue-800">100%</span>
              <span className="text-xs uppercase tracking-wider mt-1 text-blue-800">Quality Service</span>
            </div>
          </div>
        </div>
        {/* Image Block */}
        <div className="flex flex-col gap-4 sm:gap-6" data-aos="fade-left" data-aos-duration="1200">
          <div className="rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl border-4 border-white">
            <img src="https://images.pexels.com/photos/261102/pexels-photo-261102.jpeg?auto=compress&fit=crop&w=600&q=80" alt="Pool Service" className="w-full h-40 sm:h-56 object-cover" />
          </div>
          <div className="flex gap-3 sm:gap-4">
            <div className="rounded-xl sm:rounded-2xl overflow-hidden shadow-lg border-2 border-white w-1/2">
              <img src="https://images.pexels.com/photos/1001965/pexels-photo-1001965.jpeg?auto=compress&fit=crop&w=300&q=80" alt="Pool Cleaning" className="w-full h-24 sm:h-32 object-cover" />
            </div>
            <div className="rounded-xl sm:rounded-2xl overflow-hidden shadow-lg border-2 border-white w-1/2">
              <img src="https://images.pexels.com/photos/2417842/pexels-photo-2417842.jpeg?auto=compress&fit=crop&w=300&q=80" alt="Pool Maintenance" className="w-full h-24 sm:h-32 object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-2 sm:px-4 pb-12 sm:pb-16" data-aos="fade-up" data-aos-duration="1200">
        <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-blue-900 mb-3 sm:mb-4">Domain Expertise</h3>
        ...
        <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-blue-900 mb-3 sm:mb-4">Infrastructure & Quality</h3>
      ...
      <section className="max-w-7xl mx-auto px-2 sm:px-4 pb-16 sm:pb-20" data-aos="fade-up" data-aos-duration="1200">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-center text-blue-900 mb-8 sm:mb-10">Our Products</h2>
        <div className="relative">
          <Slider {...sliderSettings}>
            {imageEntries.map(([path, module], index) => (
              <div
                key={path}
                className="bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden p-3 sm:p-4 flex items-center justify-center hover:shadow-xl transition-shadow duration-300 mx-1 sm:mx-2"
              >
                <img
